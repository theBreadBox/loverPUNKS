...
import logo from "../images/LUVR_LOGO1.png.webp"
...
function Mint() {
	...
	//Links
	const [openseaURL, setOpenseaURL] = useState('https://opensea.io/collection/bakedbluejaysofficial')
	const [websiteURL, setWebsiteURL] = useState('https://www.BakedBlueJays.io')
	const [contractOpenseaURL, setContractOpenseaURL] = useState('https://opensea.io/collection/bakedbluejaysofficial')
...
//console.log(accounts)
	...
	const renderSupplyAvailable = () => {
		if (!account) {
			...
			return <AmountMinted>{666-totalMinted} of {'666'} LEFT <br/>0.3 per NFT</AmountMinted>
