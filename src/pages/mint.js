...
import logo from "../images/NEW_LOGO.png.webp"
import Twitter from "../images/twitter_logo.png"
import Discord from "../images/discordLogo1.png"
import Opensea from "../images/opensea-logo.png"
import Closed from "../images/LUVR_MINT1.png" 
import Open from "../images/LUVR_MINT2.png"
...
function Mint() {
	...
	const [totalLovers, setTotalLovers] = useState("666")
    const [totalMinted, setTotalMinted] = useState(0)
	const [cost, setCost] =useState(null)
	//Links
	const [openseaURL, setOpenseaURL] = useState('https://opensea.io/collection/LoverBoysNFT')
	const [websiteURL, setWebsiteURL] = useState('https://www.LoverBoy.ai')
	const [contractOpenseaURL, setContractOpenseaURL] = useState('https://opensea.io/collection/LoverBoysNFT')
	const [twitterURL, setTwitterURL] = useState('https://www.twitter.com/LoverBoyNFTS')
	const [discordURL, setDiscordURL] = useState('https://discord.gg/68rApQewRx')
	const [blockchainExplorerURL, setBlockchainExplorerURL] = useState('https://etherscan.io/0xcD566480fe8491c1453981f6AD44a43F8aDD6Fc2')
	//Misc
...
//console.log(accounts)
	...
	const renderHandleButton = () => {
		...
		else 
		{
			...
			return <GridCol sm={12} md={6}>
				<MintLabel for="qty">{cost}How many?</MintLabel><InputWrapper><InputArrows onClick={decreaseClick}>-</InputArrows><MintInput onChange={handleInput} type="number" name="Qty" id="Qty" max="50" min="1" value={inputValue}/><InputArrows onClick={increaseClick}>+</InputArrows></InputWrapper>
	...
	const renderSupplyAvailable = () => {
		if (!account) {
			...
			return <AmountMinted>{666-totalMinted} of {'666'} LEFT <br/>.069 per NFT</AmountMinted>
